...
-keep class com.numero.storm.data.model.** { *; }
...
-keep,includedescriptorclasses class com.numero.storm.**$$serializer { *; }
-keepclassmembers class com.numero.storm.** {
    *** Companion;
}
-keepclasseswithmembers class com.numero.storm.** {
    kotlinx.serialization.KSerializer serializer(...);
}
